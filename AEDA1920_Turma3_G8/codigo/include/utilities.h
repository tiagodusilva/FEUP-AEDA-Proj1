...
namespace utl
{
	...
	*/
	...
	/**
	 * @brief	Trim given string of empty/transparent characters from the left end
	 *
	 ...
	 *
	 * @returns	The given string with all empty characters from the left end trimmed
	*/
	std::string& ltrim(std::string& str, const std::string& chars = "\t\n\v\f\r ");

	/**
	 * @brief	Trim given string of empty/transparent characters from the right end
	 *
	 * @param str	Reference to the string to be trimmed
	 * @param chars	String containing the characters to match for trimming (default: "\\t\\n\\v\\f\\r ")
	 *
	 * @returns	The given string with all empty characters from the right end trimmed
	*/
	 ...
	 * @param chars	String containing the characters to match for trimming (default: "\\t\\n\\v\\f\\r ")
	 *
	 * @returns	The given string with all empty characters from both ends trimmed
	*/
	...
	*/
	 ...
	 *
	 * @note	Expects y/n answer (lowercase). If the return is true, 'c' will contain either 'y' or 'n' (lowercase)
	 *
	...
	*/
	 ...
	 * @note	When it returns false, a more detailed message is given in the error string
	 *
	 * @param stream	Reference to the stream to check
	 * @param error		Reference to the error string to print (in case of EOF or fail)
	 *
	...
	*/
	 ...
	 *
	 * @details	If a minimum or maximum number are given it forces the user to write an integer\n
	 *		between the given range [min, max] (inclusive)
	 *
	 * @param stream	'istream' to read the user input from
	 * @param min		Optional minimum value the user has to input (default: INT32_MIN)
	 * @param max		Optional maximum value the user has to input (default: INT32_MAX)
	 * @param message	Optional message to write before waiting for the user input (default: "")
	*/
