...
void MuseumNetwork::removeEvents(std::vector<Event> &events_to_be_removed) {
	...
	for (i = 0; i < events_to_be_removed.size(); ++i) {
		...
		iter = find_if(enterprises.begin(), enterprises.end(),
					[&event](const Enterprise &enterprise) { return(enterprise.has_event(event.get_id())); });
...
void MuseumNetwork::importCards(const std::string &cards_file_name) {
...
void MuseumNetwork::importMuseums(const std::string &museum_file_name) {
...
void MuseumNetwork::importEnterprises(const std::string &enterprise_file_name) {
...
void MuseumNetwork::exportCards(const std::string &cards_file_name) const {
...
void MuseumNetwork::exportMuseums(const std::string &museum_file_name) const {
...
void MuseumNetwork::exportEnterprises(const std::string &enterprises_file_name) const {
...
void MuseumNetwork::exportFiles(const std::string &config_file_name, const std::string &cards_file_name, const std::string &museum_file_name,
...
void MuseumNetwork::importFiles(const std::string &network_file_name) {
