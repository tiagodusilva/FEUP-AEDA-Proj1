...
public:
	...
	*/
	 ...
	 * @throws ObjectAlreadyExists	Thrown if the Event already exists in the Enterprise\n
	 ...
	 *
	 * @throws    NoSuchObject	Only throws this exception when not in garbage collection mode (id != 0), if
